...
@section('content')
<div id="label_padding" class="col-xs-8 col-sm-6 col-md-5 col-lg-5">
                    ...
                    <td bgcolor="#F2F2F2">
                        <div class="row">
                            ...
                            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                                <p class="textStyle" align="left"><a href="profile">Anonymous-userName</a></p>
                                <p class="textStyle">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" align="right">
                                <p class="textStyle2"><b>Was this review helpful?</b></p>
                                <div class="btn-group btn-group-xs"  align="right">
